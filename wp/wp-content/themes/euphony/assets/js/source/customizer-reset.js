jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", euphonyCustomizerReset.confirm, euphonyCustomizerReset.reset],
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: euphonyCustomizerReset.nonce.reset,
                section: o[1]
            };
