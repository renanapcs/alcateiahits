...
?>
	...
	<footer id="colophon" class="site-footer<?php echo esc_attr( get_theme_mod( 'euphony_footer_bg_image', trailingslashit( esc_url( get_template_directory_uri() ) ) . 'assets/images/footer-bg.jpg' ) ) ? ' has-background-image' : ''; ?>">
