<?php
/**
 * Euphony Theme Options Sanitization Functions
 *
 * @package Euphony
 */
 ...
 */
function euphony_sanitize_select( $input, $setting ) {
 ...
 */
function euphony_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function euphony_sanitize_post( $input ) {
 ...
 */
function euphony_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function euphony_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function euphony_sanitize_number_range( $number, $setting ) {
